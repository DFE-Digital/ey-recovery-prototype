...
const alphaHeaderPath = require.resolve(
  'dfe-frontend-alpha/packages/components/header/macro.njk'
);

console.log('alphaHeaderPath: ' + alphaHeaderPath);
console.log(
  'fs.existsSync(alphaHeaderPath): ' + fs.existsSync(alphaHeaderPath)
);
...
nunjucksAppEnv.addGlobal('alphaHeader', alphaHeaderPath);
